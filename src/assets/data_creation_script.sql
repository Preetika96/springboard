 ...
 ALTER TABLE EMP ADD CONSTRAINT EMP_DEPT_ID_REF FOREIGN KEY (DEPT_NO)
	  REFERENCES DEPT (ID) ON DELETE CASCADE ENABLE;
...
Insert into EMP (ID,NAME,SALARY,COMMISSION,ROLE,DEPT_NO,HIRED_DATE,MANAGER_ID) values (8,Steve,18000,200,Clerk,3,null,null);
